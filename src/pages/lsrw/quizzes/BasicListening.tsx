...
const BasicListening = () => {
  ...
  const questions = [
    {
      id: 1,
      title: "What time does the meeting start?",
      options: [
        { id: "A", text: "9:00 AM" },
        { id: "B", text: "10:00 AM" },
        { id: "C", text: "11:00 AM" },
        ...
        <main className="flex-1">
          ...
          <header className="h-16 border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-10">
            <div className="container mx-auto px-4 h-full flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">Everyday Conversations</h1>
