        ...
        <main className="flex-1">
          ...
          <header className="h-16 border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-10">
            <div className="container mx-auto px-4 h-full flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">Expert L1 Listening</h1>
            ...
            <Card className="text-center py-16">
              <CardContent className="space-y-6">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  Complete the previous level (Intermediate L2) to unlock this advanced listening exercise.
                </p>
                <Link to="/lsrw/listening-levels">
...
export default ExpertL1Listening;